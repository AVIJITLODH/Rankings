...
map.getView().fit([-19141862.432233, -15075277.647383, 20018906.632997, 44927335.427097], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Country-wise Current Ranks </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (126 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web interactive made by Avijit Lodh shows country-wise  current ranking . <br />[ Note : the data is collected on 20/7/2026. ]';
            }
